...
export function renderMenu(ctx: CanvasRenderingContext2D) {
    ctx.font = '30px Arial';
    ...
    ctx.canvas.addEventListener('click', function(e: any) {
    ...
    for (let i = 0; i < menuItems.length; i++) {
        if (x + spacing > canvasWidth) break; // Ensure the item is within the menu area
