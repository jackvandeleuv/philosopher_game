export class FrozenMenu {
    constructor(ctx) {
        this.ctx = ctx;
        this.nextState = null;
        this.buttonWidth = this.ctx.canvas.width / 1.5;
        this.buttonHeight = this.ctx.canvas.height / 10;
        this.y = this.ctx.canvas.height * 5 / 6;
        this.x = (this.ctx.canvas.width / 2) - (this.buttonWidth / 2);
        this.menuItems = [
            {
